...
const RP = (() => {
  ...
  const ROADMAPS = [
    ...
    // Cloud & DevOps
    { id: "cloud-engineer", name: "Cloud Engineer", category: "Cloud & DevOps", desc: "AWS, Azure, and cloud infrastructure.", duration: "12 Weeks", difficulty: "Intermediate", price: 29, icon: "server", rating: 4.8, students: 3000, tags: ["Cloud", "AWS", "Azure"], demand: "Very High" },
    { id: "devops-engineer", name: "DevOps Engineer", category: "Cloud & DevOps", desc: "CI/CD, Docker, Kubernetes, and Terraform.", duration: "16 Weeks", difficulty: "Advanced", price: 29, icon: "server", rating: 4.9, students: 4200, tags: ["DevOps", "Docker", "K8s"], demand: "Very High" },

    // Cyber Security
    { id: "cyber-security", name: "Cyber Security Analyst", category: "Cyber Security", desc: "Network security, ethical hacking, and defense.", duration: "14 Weeks", difficulty: "Advanced", price: 29, icon: "cpu", rating: 4.7, students: 2800, tags: ["Security", "Hacking", "Network"], demand: "High" },

    // Core Engineering
    { id: "civil-engineer", name: "Civil Engineering Core", category: "Engineering", desc: "Structures, AutoCAD, and construction management.", duration: "20 Weeks", difficulty: "Advanced", price: 29, icon: "globe", rating: 4.6, students: 1500, tags: ["Civil", "AutoCAD", "Structures"], demand: "Stable" },
    { id: "mechanical-engineer", name: "Mechanical Engineering Core", category: "Engineering", desc: "Thermodynamics, CAD, and manufacturing.", duration: "20 Weeks", difficulty: "Advanced", price: 29, icon: "cpu", rating: 4.7, students: 1800, tags: ["Mech", "CAD", "Thermodynamics"], demand: "Stable" },
    { id: "electronics-engineer", name: "Electronics & Communication", category: "Engineering", desc: "Circuits, microcontrollers, and IoT.", duration: "20 Weeks", difficulty: "Advanced", price: 29, icon: "cpu", rating: 4.8, students: 2100, tags: ["ECE", "IoT", "Circuits"], demand: "High" }
  ];
